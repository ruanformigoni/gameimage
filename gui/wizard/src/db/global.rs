...
pub struct Entry
{
  pub project: Option<PathBuf>, // path to default project
  pub path_dir_build: Option<PathBuf>, // path to build dir
  pub projects: Option<Vec<PathBuf>>, // list of projects by name
} // Entry }}}
